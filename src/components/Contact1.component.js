  ...
  render() {
    ...
    return (
      <MDBContainer>
        ...
        <MDBRow>
        <MDBCol>
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfN3xkZrPf2fTGlJvA5QIeWqi2-eafmlhpLh2mV8IEnxhHDYQ/viewform?embedded=true" width="450" height="947" frameBorder="0" marginHeight="0" marginWidth="0">Loading…</iframe>
        </MDBCol>
        <MDBCol lg="6">
          <div
            id="map-container"
