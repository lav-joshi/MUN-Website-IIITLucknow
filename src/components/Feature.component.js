...
import {  MDBRow, MDBCol, MDBIcon , MDBAnimation,MDBContainer } from "mdbreact";
    ...
    <section className="my-5">
       <MDBAnimation  reveal type="zoomIn" duration="600ms" delay="0.5s">
        ...
        <MDBRow>
          ...
          <MDBAnimation  reveal type="fadeInDown" duration="800ms" delay="1s">
            <img
          ...
          <MDBCol lg="7">
          <MDBAnimation  reveal type="fadeInUp" duration="1000ms" delay="1.5s">
